...
class SubmissionsPage extends StatefulWidget {
  const SubmissionsPage({Key? key})
      : super(
          key: key,
        );

  @override
  SubmissionsPageState createState() =>
      SubmissionsPageState();
}
// ignore_for_file: must_be_immutable

// ignore_for_file: must_be_immutable
class SubmissionsPageState
    extends State<SubmissionsPage> with TickerProviderStateMixin {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TabBarView(
                  controller: tabviewController,
                  children: [
                    SubmissionSection(status: Status.processing,),
                    SubmissionSection(status: Status.approved,),
                    SubmissionSection(status: Status.rejected,),],
                ),
              )
            ],
          ),
